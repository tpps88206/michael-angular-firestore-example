...
@Component({
  selector: 'ngx-user-uncheck',
  templateUrl: './user-uncheck.component.html',
  styleUrls: ['./user-uncheck.component.scss'],
})
export class UserUncheckComponent implements OnDestroy, OnInit {
  options: any = {};
